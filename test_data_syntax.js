...
const WC_THEMES = [
    {
        ...
        accent: '#e11d48',
        words: ["MAT", "ÄT", "KAFFE", "MJÖLK", "OST", "FRUKOST", "MIDDAG", "SOCKER", "PEPPAR", "SALT", "KORV", "BRÖD", "VATTEN", "TE", "KAKA", "BÄR", "FISK", "KÖTT", "SOFFA", "BORD"] // Mixed some household items if needed
    },
    {
        id: 'nature',
        ...
        accent: '#059669',
        words: ["TRÄD", "BLOMMA", "SOL", "MÅNE", "HAV", "SJÖ", "BERG", "SKOG", "STEN", "GRÄS", "VIND", "REGN", "SNÖ", "IS", "ELD", "DJUR", "FÅGEL", "FISK", "HUND", "KATT"]
    },
    {
        id: 'travel',
        name: 'Resor / السفر',
        ...
        accent: '#2563eb',
        words: ["RESA", "TÅG", "BIL", "BUSS", "BÅT", "FLYG", "HOTELL", "VÄSKA", "PASS", "KARTA", "STAD", "LAND", "HAV", "STRAND", "SOL", "BAD", "BILJETT", "TURIST"]
    },
    {
        id: 'daily',
        ...
        accent: '#d97706',
        words: ["HEM", "HUS", "RUM", "SÄNG", "STOL", "BORD", "LAMPA", "DÖRR", "FÖNSTER", "NYCKEL", "TELEFON", "DATOR", "KLOCKA", "BOK", "PENNA", "SKOLA", "JOBB", "PENGAR"]
    }
];
...
const WC_PREDEFINED_LEVELS = {
    // --- CHAPTER 1: Mat & Dryck (Food) 🍎 ---
    "1-1": { letters: ["M", "A", "T"], words: ["MAT", "TA"], validWords: ["MAT", "TA"] },
    "1-2": { letters: ["T", "E"], words: ["TE"], validWords: ["TE"] }, // Very simple start
    ...
    "1-7": { letters: ["K", "Ö", "T", "T"], words: ["KÖTT", "ÖT"], validWords: ["KÖTT", "ÖT"] }, // ÖT is rare/dialect but maybe just KÖTT
    ...
    "2-9": { letters: ["S", "K", "O", "G"], words: ["SKOG", "KO", "OS", "GÅ"], validWords: ["SKOG", "KO", "OS", "GÅ"] },
    ...
    "5-9": { letters: ["L", "Ö", "K", "A", "R"], words: ["LÖKAR", "LÖK", "KÄR", "LÄR"], validWords: ["LÖKAR", "LÖK", "KÄR", "LÄR"] }, // Added LÖK
