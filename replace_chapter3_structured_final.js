...
const structuredChapter3 = [
    ...
    { main: "KANOT", targets: ["KANOT", "KANT", "TANK"], data: { "KANOT": { t: "زورق", s: "Vi paddlar kanot i ån.", st: "نحن نجدف بالزورق في النهر." }, "KANT": { t: "حافة", s: "Han satt på kanten av sängen.", st: "جلس على حافة السرير." }, "TANK": { t: "خزان", s: "Bilen har full tank.", st: "السيارة بها خزان ممتلئ." } } },
    ...
    { main: "MATROS", targets: ["MATROS", "ROSA", "ROSTA", "RASAT"], data: { "MATROS": { t: "بحار", s: "Han arbetar som matros.", st: "يعمل كبحار." }, "ROSA": { t: "وردي", s: "Hon gillar rosa kläder.", st: "هي تحب الملابس الوردية." }, "ROSTA": { t: "يحمص / يصدأ", s: "Järn kan rosta.", st: "الحديد يمكن أن يصدأ." }, "RASAT": { t: "انهار", s: "Taket har rasat in.", st: "لقد انهار السقف." } } },
...
if (startIndex !== -1 && nextChapterIndex !== -1) {
    ...
    console.log("Replaced Chapter 3 with FINAL STRUCTURED perfect travel levels.");
} else {
